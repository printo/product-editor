...
| **Date** | May 6, 2026 |
| **Status** | *In Progress — second runtime/UX hardening pass complete; cover-mode bug fixed; Service Worker live; `_DEV`-gated logs; imposition modal custom W×H input* |
| **Version** | v1.10 |
